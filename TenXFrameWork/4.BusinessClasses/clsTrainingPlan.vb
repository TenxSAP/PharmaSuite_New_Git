...
#End Region
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("TrainingPlan.xml", "frm_TRANIPLN", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_TRANIPLN", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
        ...
        Try
            Select Case pVal.EventType
                ...
                Case SAPbouiCOM.BoEventTypes.et_DOUBLE_CLICK
                    If pVal.ItemUID = "1_U_G" And pVal.ColUID = "C_1_1" And pVal.BeforeAction = False Then
                        objForm = objMain.objApplication.Forms.Item(FormUID)
                        Dim objMatrix As SAPbouiCOM.Matrix = objForm.Items.Item("1_U_G").Specific


                        If pVal.Row > 0 AndAlso pVal.Row <= objMatrix.VisualRowCount Then
                            Dim fullPath As String = objMatrix.Columns.Item("C_1_1").Cells.Item(pVal.Row).Specific.Value
                            If Not String.IsNullOrEmpty(fullPath) AndAlso fullPath.Contains("\") Then
                                ...
                                objMatrix.Columns.Item("C_1_2").Cells.Item(pVal.Row).Specific.Value = filename
                                objMatrix.Columns.Item("C_1_3").Cells.Item(pVal.Row).Specific.Value = DateTime.Now.ToString("yyyyMMdd")
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_TRNPH")
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_TRNPLAN"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_TRNPH")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_TRNPL")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_TRNP_ATT")
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details1.SetValue("U_EmpName", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Position", oDBs_Details1.Offset, "")
            ...
            If objMatrix2.VisualRowCount = 0 Then
                ...
                oDBs_Details2.SetValue("U_TPA", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_FN", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_ATD", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_FTT", oDBs_Details2.Offset, "")
