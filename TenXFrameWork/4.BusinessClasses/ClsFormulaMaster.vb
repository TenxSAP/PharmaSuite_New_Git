...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("NewFormulaMaster.xml", "PHFARM", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("PHFARM", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_PH_FORMULA")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_PH_FORMULA_D1")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_PH_FORMULA_D2")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_PH_FORMULA_D3")
            oDBs_Details4 = objForm.DataSources.DBDataSources.Item("@TNX_PH_FORMULA_D4")
            oDBs_Details5 = objForm.DataSources.DBDataSources.Item("@TNX_PH_FORMULA_D5")
            oDBs_Details6 = objForm.DataSources.DBDataSources.Item("@TNX_PH_FORMULA_D6")
            ...
            objMatrix4 = objForm.Items.Item("MXT_4").Specific
            objMatrix5 = objForm.Items.Item("MXT_5").Specific
            objMatrix6 = objForm.Items.Item("MXT_6").Specific
            'oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_PHUDO"))
            'oDBs_Head.SetValue("U_DDate", 0, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.MenuUID = "10X_FRM_MST" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Public Function Validate() As Boolean
        ...
        Try
            If oDBs_Head.GetValue("U_TNXCODE", 0) = "" Then
                objMain.objApplication.SetStatusBarMessage("Customer Code is Missing", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)                'Me.FormText(enControlName.Financeyear).Active = True
                Return False
                Exit Function
            End If
            Return True
    ...
    Private Sub SetNewLine1(ByVal FormUID As String)
        Try
            ...
            oDBs_Details1.SetValue("U_ICode", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_IName", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_IType", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_ReqQty", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_UOM", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_CompPrc", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_OPrc", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_LossPrc", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_FQty", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_Function", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_Mandatory", oDBs_Details1.Offset, "N")
    ...
    Private Sub SetNewLine2(ByVal FormUID As String)
        Try
            ...
            oDBs_Details2.SetValue("U_PStage", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Instruction", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_MType", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Temperature", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Time", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_DUOM", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_CPara", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_QCCheck", oDBs_Details2.Offset, "")
    ...
    Private Sub SetNewLine3(ByVal FormUID As String)
        Try
            ...
            oDBs_Details3.SetValue("U_PCode", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_PName", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_EValue", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_MinValue", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_MaxValue", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_TMethod", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_CheckBox", oDBs_Details3.Offset, "")
    ...
    Private Sub SetNewLine4(ByVal FormUID As String)
        Try
            ...
            oDBs_Details4.SetValue("U_ItemCost", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_PCost", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_TestCost", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_PackCost", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_TCost", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_CPUnit", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_Currency", oDBs_Details4.Offset, "")
    ...
    Private Sub SetNewLine5(ByVal FormUID As String)
        Try
            ...
            oDBs_Details5.SetValue("U_CurrentVersion", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_RevisionReason", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_ApprovalStatus", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_ApprovedBy", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_ApprovedDate", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_Locked", oDBs_Details5.Offset, "N")
            oDBs_Details5.SetValue("U_Change", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_Approved", oDBs_Details5.Offset, "")
    ...
    Private Sub SetNewLine6(ByVal FormUID As String)
        Try
            ...
            oDBs_Details6.SetValue("U_DocType", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_FName", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_FPath", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_UPload", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_UDate", oDBs_Details6.Offset, "")
    ...
    Sub FormDataEvent(ByRef BusinessObjectInfo As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean)
        Try
            objForm = objMain.objApplication.Forms.GetForm("ACNGW", objMain.objApplication.Forms.ActiveForm.TypeCount)
            Select Case BusinessObjectInfo.EventType
                Case SAPbouiCOM.BoEventTypes.et_FORM_DATA_LOAD
                    If BusinessObjectInfo.BeforeAction = False And BusinessObjectInfo.ActionSuccess = True Then
                        If objForm.Items.Item("ARNum").Specific.Value <> "" Then
                            objForm.Mode = SAPbouiCOM.BoFormMode.fm_VIEW_MODE
                        Else
                            objForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE
                        End If
                        If objForm.Items.Item("APDocNum").Specific.Value <> "" Then
                            objForm.Mode = SAPbouiCOM.BoFormMode.fm_VIEW_MODE
                        Else
                            objForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE
                        End If
                    End If
                    objForm.Items.Item("TNXFD").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                    objForm.Items.Item("TNXTD").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
                    objForm.Items.Item("AV").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            End Select
        Catch ex As Exception
            objMain.objApplication.StatusBar.SetText(ex.Message)
        End Try
    ...
    Sub SetDefault(ByVal FormUID As String, Optional ByVal Flag As String = "", Optional ByVal Series As Integer = 0)
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_PHUDO", "Primary"))
            oDBs_Head.SetValue("U_DDate", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
            'objMatrix1.Clear()
            'objMatrix2.Clear()
            'objMatrix3.Clear()
            'objMatrix4.Clear()
