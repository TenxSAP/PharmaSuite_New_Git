...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("SampleType.xml", "10X_STYPE", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_STYPE", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            'CheckCorporateTaxConfigSetup()
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_STYPE")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_QC_STYPE" AndAlso pVal.BeforeAction = False Then
            ...
            ElseIf pVal.MenuUID = "1292" AndAlso pVal.BeforeAction = False Then
                ...
                If objForm.TypeEx <> "10X_STYPE" Then Exit Sub
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_SourDoc", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_DefWhs", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_TestReq", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_RetainReq", oDBs_Head.Offset, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Add("@TNX_QC_STYPE")
            Dim objsectMat As SAPbouiCOM.Matrix = objForm.Items.Item("MXT_1").Specific

            Dim rs1 As String = "SELECT ""DocEntry"",""Code"", ""Name"", ""U_SourDoc"", ""U_DefWhs"", ""U_TestReq"", ""U_RetainReq"",""U_Active"" " &
"FROM ""@TNX_QC_STYPE"" ORDER BY ""Code"" "
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 1 To ors1.RecordCount
                    ...
                    oDBs_Head.SetValue("U_SourDoc", oDBs_Head.Offset, ors1.Fields.Item("U_SourDoc").Value)
                    oDBs_Head.SetValue("U_DefWhs", oDBs_Head.Offset, ors1.Fields.Item("U_DefWhs").Value)
                    oDBs_Head.SetValue("U_TestReq", oDBs_Head.Offset, ors1.Fields.Item("U_TestReq").Value)
                    oDBs_Head.SetValue("U_RetainReq", oDBs_Head.Offset, ors1.Fields.Item("U_RetainReq").Value)
