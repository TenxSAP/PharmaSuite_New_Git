Public Class clsMstrCorrectiveAction
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrCorrectiveAction.xml", "frm_CORACT", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_CORACT", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_CORACT")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_CORACT""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_CMS_CORACT" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_EvidenceR", rowIndex, "Y")
            oDBs_Head.SetValue("U_ApprovalR", rowIndex, "Y")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_ActionDesc"", ""U_DefaultO"", ""U_TargetDays"", ""U_EvidenceR"", ""U_ApprovalR"", ""U_Active"" " & "FROM ""@TNX_CORACT"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_ActionDesc", j, ors1.Fields.Item("U_ActionDesc").Value.ToString())
                    oDBs_Head.SetValue("U_DefaultO", j, ors1.Fields.Item("U_DefaultO").Value.ToString())
                    oDBs_Head.SetValue("U_TargetDays", j, ors1.Fields.Item("U_TargetDays").Value.ToString())
                    oDBs_Head.SetValue("U_EvidenceR", j, ors1.Fields.Item("U_EvidenceR").Value.ToString())
                    oDBs_Head.SetValue("U_ApprovalR", j, ors1.Fields.Item("U_ApprovalR").Value.ToString())
                    oDBs_Head.SetValue("U_Active", j, ors1.Fields.Item("U_Active").Value.ToString())
