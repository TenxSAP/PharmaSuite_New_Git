...
Public Class ClsCAPAManagement
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("CAPAManagement.xml", "10X_CAPA", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_CAPA", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_CAPAH")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_CAPAL")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_CAPAE")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_CAPAW")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_CAPAA")
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_CAPA_UDO", "Primary"))
            oDBs_Head.SetValue("U_DDK", 0, DateTime.Now.ToString("yyyyMMdd"))
            ...
            objForm.Items.Item("DDK").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, -1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            objForm.Items.Item("DDK").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_CAPA_UDO"))
            oDBs_Head.SetValue("U_DDK", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_ACTION_TYPE", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ACTION_DESC", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RESP_PERSON", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_DEPT", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_DUE_DATE", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_COMPLETION_DT", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ACTION_STATUS", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_EVIDENCE_REQ", oDBs_Details.Offset, "")
            ...
            If objMatrix2.VisualRowCount = 0 Then
                ...
                oDBs_Details1.SetValue("U_CHECK_DATE", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_CHECK_BY", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_METHOD", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_RESULT", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_OBSERVATION", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_REOPEN_REQ", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_NEXT_ACTION", oDBs_Details1.Offset, "")
            ...
            If objMatrix3.VisualRowCount = 0 Then
                ...
                oDBs_Details2.SetValue("U_APPROVER", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_APPROVAL_STATUS", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_APPROVAL_DATE", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_COMMENTS", oDBs_Details2.Offset, "")
            ...
            If objMatrix4.VisualRowCount = 0 Then
                ...
                'oDBs_Details3.SetValue("LineId", oDBs_Details3.Offset, objMatrix4.VisualRowCount.ToString())
                oDBs_Details3.SetValue("U_DOC_TYPE", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_FILE_NAME", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_FILE_PATH", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_UPLOADED_BY", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_UPLOAD_DATE", oDBs_Details3.Offset, "")
