Public Class ClsMstrIngredientType
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrIngredientType.xml", "frm_INGTYPE", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_INGTYPE", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_ING_TYPE")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_ING_TYPE""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_RD_INGTYP" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_SAPItemGroup", rowIndex, "")
            oDBs_Head.SetValue("U_QCRequired", rowIndex, "Y")
            oDBs_Head.SetValue("U_ExpiryRequired", rowIndex, "Y")
            oDBs_Head.SetValue("U_BatchManaged", rowIndex, "Y")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_SAPItemGroup"", ""U_QCRequired"", ""U_ExpiryRequired"", ""U_BatchManaged"", ""U_Status"" " & "FROM ""@TNX_ING_TYPE"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_SAPItemGroup", j, ors1.Fields.Item("U_SAPItemGroup").Value.ToString())
                    oDBs_Head.SetValue("U_QCRequired", j, ors1.Fields.Item("U_QCRequired").Value.ToString())
                    oDBs_Head.SetValue("U_ExpiryRequired", j, ors1.Fields.Item("U_ExpiryRequired").Value.ToString())
                    oDBs_Head.SetValue("U_BatchManaged", j, ors1.Fields.Item("U_BatchManaged").Value.ToString())
