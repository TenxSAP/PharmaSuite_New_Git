...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("TestParameters.xml", "10X_TPARM", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_TPARM", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            'CheckCorporateTaxConfigSetup()
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_TPARM")
    ...
    '        rs.DoQuery("SELECT COUNT(*) AS ""Cnt"" FROM ""@TNX_QC_DEVCAT""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_QC_TPARM" AndAlso pVal.BeforeAction = False Then
            ...
            ElseIf pVal.MenuUID = "1292" AndAlso pVal.BeforeAction = False Then
                ...
                If objForm.TypeEx <> "10X_TPARM" Then Exit Sub
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_ParmType", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_UOM", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_DecPlace", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_MinValue", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_MaxValue", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_CalcReq", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_Formula", oDBs_Head.Offset, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String = "SELECT ""DocEntry"",""Code"", ""U_ParmType"", ""U_UOM"", ""U_DecPlace"", ""U_MinValue"",""U_MaxValue"",""U_CalcReq"",""U_Formula"",""U_Remarks"",""U_Active"" " &
                                "FROM ""@TNX_QC_TPARM"" ORDER BY ""Code"" "
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 1 To ors1.RecordCount
                    ...
                    oDBs_Head.SetValue("DocEntry", oDBs_Head.Offset, objsectMat.VisualRowCount.ToString())
                    oDBs_Head.SetValue("Code", oDBs_Head.Offset, objsectMat.VisualRowCount.ToString())
                    oDBs_Head.SetValue("U_ParmType", oDBs_Head.Offset, ors1.Fields.Item("U_ParmType").Value.ToString())
                    oDBs_Head.SetValue("U_UOM", oDBs_Head.Offset, ors1.Fields.Item("U_UOM").Value.ToString())
                    oDBs_Head.SetValue("U_DecPlace", oDBs_Head.Offset, ors1.Fields.Item("U_DecPlace").Value.ToString())
                    oDBs_Head.SetValue("U_MinValue", oDBs_Head.Offset, ors1.Fields.Item("U_MinValue").Value.ToString())
                    oDBs_Head.SetValue("U_MaxValue", oDBs_Head.Offset, ors1.Fields.Item("U_MaxValue").Value.ToString())
                    oDBs_Head.SetValue("U_CalcReq", oDBs_Head.Offset, ors1.Fields.Item("U_CalcReq").Value.ToString())
                    oDBs_Head.SetValue("U_Formula", oDBs_Head.Offset, ors1.Fields.Item("U_Formula").Value.ToString())
                    oDBs_Head.SetValue("U_Remarks", oDBs_Head.Offset, ors1.Fields.Item("U_Remarks").Value.ToString())
                    oDBs_Head.SetValue("U_Active", oDBs_Head.Offset, ors1.Fields.Item("U_Active").Value.ToString())
    ...
    '    Public Sub MatrixLoad()
    '        Try
    '            oDBs_Head.Freeze(True)

    '            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_SOP")
    '            Dim objsectMat As SAPbouiCOM.Matrix = objForm.Items.Item("MXT_1").Specific

    '            Dim rs1 As String = "SELECT ""DocEntry"",""Code"", ""Name"", ""U_Dept"", ""U_Version"", ""U_EffDate"",""U_ReviewD"",""U_Attach"",""U_Status"" " &
    '"FROM ""@TNX_QC_DEVCAT"" ORDER BY ""Code"" "
    ...
    '                    oDBs_Head.SetValue("U_Dept", oDBs_Head.Offset, ors1.Fields.Item("U_Dept").Value)
    '                    oDBs_Head.SetValue("U_Version", oDBs_Head.Offset, ors1.Fields.Item("U_Version").Value)
    '                    oDBs_Head.SetValue("U_EffDate", oDBs_Head.Offset, ors1.Fields.Item("U_EffDate").Value)
    '                    oDBs_Head.SetValue("U_ReviewD", oDBs_Head.Offset, ors1.Fields.Item("U_ReviewD").Value)
    '                    oDBs_Head.SetValue("U_Attach", oDBs_Head.Offset, ors1.Fields.Item("U_Attach").Value)
    '                    oDBs_Head.SetValue("U_Status", oDBs_Head.Offset, ors1.Fields.Item("U_Status").Value)
    '                    objsectMat.SetLineData(objsectMat.VisualRowCount)
    '                    ors1.MoveNext()
    '                Next
    '                objForm.Mode = SAPbouiCOM.BoFormMode.fm_OK_MODE
