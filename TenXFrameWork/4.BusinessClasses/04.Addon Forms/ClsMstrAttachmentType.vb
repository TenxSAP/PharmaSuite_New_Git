Public Class ClsMstrAttachmentType
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrAttachmentType.xml", "frm_ATTTYPE", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_ATTTYPE", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_ATT_TYPE")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_ATT_TYPE""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_RD_ATTYPE" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_FileExtensions", rowIndex, "")
            oDBs_Head.SetValue("U_ApprovalRequired", rowIndex, "Y")
            oDBs_Head.SetValue("U_RetentionYears", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_ObjectType"", ""U_Mandatory"", ""U_FileExtensions"", ""U_ApprovalRequired"", ""U_RetentionYears"", ""U_Status"" " & "FROM ""@TNX_ATT_TYPE"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_Mandatory", j, ors1.Fields.Item("U_Mandatory").Value.ToString())
                    oDBs_Head.SetValue("U_FileExtensions", j, ors1.Fields.Item("U_FileExtensions").Value.ToString())
                    oDBs_Head.SetValue("U_ApprovalRequired", j, ors1.Fields.Item("U_ApprovalRequired").Value.ToString())
                    oDBs_Head.SetValue("U_RetentionYears", j, ors1.Fields.Item("U_RetentionYears").Value.ToString())
