Public Class ClsMstrProcessStage
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrProcessStage.xml", "frm_PSTAGE", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_PSTAGE", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_PROC_STAGE")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_PROC_STAGE""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_RD_STAGE" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_StageType", rowIndex, "")
            oDBs_Head.SetValue("U_DefaultSeq", rowIndex, "")
            oDBs_Head.SetValue("U_QCCheckpoint", rowIndex, "")
            oDBs_Head.SetValue("U_EquipmentRequired", rowIndex, "Y")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_StageType"", ""U_DefaultSeq"", ""U_QCCheckpoint"", ""U_EquipmentRequired"", ""U_Status"" " & "FROM ""@TNX_PROC_STAGE"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_StageType", j, ors1.Fields.Item("U_StageType").Value.ToString())
                    oDBs_Head.SetValue("U_DefaultSeq", j, ors1.Fields.Item("U_DefaultSeq").Value.ToString())
                    oDBs_Head.SetValue("U_QCCheckpoint", j, ors1.Fields.Item("U_QCCheckpoint").Value.ToString())
                    oDBs_Head.SetValue("U_EquipmentRequired", j, ors1.Fields.Item("U_EquipmentRequired").Value.ToString())
