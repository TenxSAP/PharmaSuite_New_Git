...
Public Class ClsMstrSpecificationHD
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("MstrSpecificationHD.xml", "frm_SPEC", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_SPEC", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            'objForm.Freeze(True)
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_SPEC_HDR")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_SPEC_DTL")

            objMatrix1 = objForm.Items.Item("MXT_1").Specific


            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_SPEC"))
            oDBs_Head.SetValue("U_EffectiveDate", 0, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details1.SetValue("U_TestParam", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_ResultType", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_MinValue", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_MaxValue", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_TargetValue", oDBs_Details1.Offset, "")
        ...
        Try
            ...
            Select Case MatrixUID
                ...
                Case "MXT_1"
                    ...
                    oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_SPEC_DTL")
                    ...
                    oDBs_Details.SetValue("U_TestParam", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_ResultType", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_MinValue", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_MaxValue", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_TargetValue", oDBs_Details.Offset, "")
