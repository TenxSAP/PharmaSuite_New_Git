...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("AuditCheck.xml", "10X_AUDCHK", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_AUDCHK", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_AUDCHK_H")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_QC_AUDCHK_L")

            objMatrix1 = objForm.Items.Item("0_U_G").Specific


            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_AUDCHK", "Primary"))
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_AUDCHK"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("LineId", oDBs_Details.Offset, objMatrix1.VisualRowCount)
                oDBs_Details.SetValue("U_RiskLevel", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_EvidenceReq", oDBs_Details.Offset, "")
