...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("RiskClassification.xml", "10X_RISK", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_RISK", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            'CheckCorporateTaxConfigSetup()
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_RISK")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_QC_RISK" AndAlso pVal.BeforeAction = False Then
            ...
            ElseIf pVal.MenuUID = "1292" AndAlso pVal.BeforeAction = False Then
                ...
                If objForm.TypeEx <> "10X_RISK" Then Exit Sub
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_RiskL", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_ImpactS", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_Score", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_TotalS", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_AppL", oDBs_Head.Offset, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Add("@TNX_QC_RISK")
            Dim objsectMat As SAPbouiCOM.Matrix = objForm.Items.Item("MXT_1").Specific

            Dim rs1 As String = "SELECT ""DocEntry"",""Code"", ""Name"", ""U_RiskL"", ""U_ImpactS"", ""U_Score"", ""U_TotalS"",""U_AppL"",""U_Active""" &
"FROM ""@TNX_QC_RISK"" ORDER BY ""Code"" "
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 1 To ors1.RecordCount
                    ...
                    oDBs_Head.SetValue("U_RiskL", oDBs_Head.Offset, ors1.Fields.Item("U_RiskL").Value)
                    oDBs_Head.SetValue("U_ImpactS", oDBs_Head.Offset, ors1.Fields.Item("U_ImpactS").Value)
                    oDBs_Head.SetValue("U_Score", oDBs_Head.Offset, ors1.Fields.Item("U_Score").Value)
                    oDBs_Head.SetValue("U_TotalS", oDBs_Head.Offset, ors1.Fields.Item("U_TotalS").Value)
                    oDBs_Head.SetValue("U_AppL", oDBs_Head.Offset, ors1.Fields.Item("U_AppL").Value)
