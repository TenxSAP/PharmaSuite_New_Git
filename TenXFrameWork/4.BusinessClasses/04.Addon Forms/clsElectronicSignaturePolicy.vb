...
Public Class clsElectronicSignaturePolicy
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("ElectronicSignaturePolicy.xml", "10X_CMS_ESIGN", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_CMS_ESIGN", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_ESIGN")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_ESIGNL")


            objMatrix1 = objForm.Items.Item("0_U_G").Specific

            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_ESIGN"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_Action", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ESignReq", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_AuthMethod", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ReasonReq", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RemarksReq", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_AuditLogReq", oDBs_Details.Offset, "Y")
        ...
        Try
            ...
            Select Case MatrixUID
                Case "0_U_G"
                    ...
                    oDBs_Details.SetValue("U_ReasonReq", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_RemarksReq", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_AuditLogReq", oDBs_Details.Offset, "")
