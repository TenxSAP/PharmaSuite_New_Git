Public Class ClsMstrDosageForm
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrDosageForm.xml", "frm_DOSFORM", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_DOSFORM", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_DOS_FORM")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_DOS_FORM""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_RD_DFORM" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_ProductCat", rowIndex, "")
            oDBs_Head.SetValue("U_DefaultBatchUOM", rowIndex, "")
            oDBs_Head.SetValue("U_ProcessTemplate", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_ProductCat"", ""U_DefaultBatchUOM"", ""U_ProcessTemplate"", ""U_Status"" " & "FROM ""@TNX_DOS_FORM"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_ProductCat", j, ors1.Fields.Item("U_ProductCat").Value.ToString())
                    oDBs_Head.SetValue("U_DefaultBatchUOM", j, ors1.Fields.Item("U_DefaultBatchUOM").Value.ToString())
                    oDBs_Head.SetValue("U_ProcessTemplate", j, ors1.Fields.Item("U_ProcessTemplate").Value.ToString())
