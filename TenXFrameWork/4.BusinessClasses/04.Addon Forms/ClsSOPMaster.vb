...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("SOPMaster.xml", "10X_SOP", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_SOP", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_QC_SOP" AndAlso pVal.BeforeAction = False Then
            ...
            ElseIf pVal.MenuUID = "1292" AndAlso pVal.BeforeAction = False Then
                ...
                If objForm.TypeEx <> "10X_SOP" Then Exit Sub
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_Dept", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_Version", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_EffDate", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_ReviewD", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_Attach", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_Status", oDBs_Head.Offset, "")
            objMatrix.SetLineData(objMatrix.VisualRowCount)
            objMatrix.AutoResizeColumns()
            objForm.Freeze(False)
        Catch ex As Exception
        ...
        Try
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 1 To ors1.RecordCount
                    ...
                    oDBs_Head.SetValue("Name", oDBs_Head.Offset, ors1.Fields.Item("Name").Value.ToString())
                    oDBs_Head.SetValue("U_Dept", oDBs_Head.Offset, ors1.Fields.Item("U_Dept").Value.ToString())
                    oDBs_Head.SetValue("U_Version", oDBs_Head.Offset, ors1.Fields.Item("U_Version").Value.ToString())
                    oDBs_Head.SetValue("U_EffDate", oDBs_Head.Offset, ors1.Fields.Item("U_EffDate").Value.ToString())
                    oDBs_Head.SetValue("U_ReviewD", oDBs_Head.Offset, ors1.Fields.Item("U_ReviewD").Value.ToString())
                    oDBs_Head.SetValue("U_Attach", oDBs_Head.Offset, ors1.Fields.Item("U_Attach").Value.ToString())
                    oDBs_Head.SetValue("U_Status", oDBs_Head.Offset, ors1.Fields.Item("U_Status").Value.ToString())
