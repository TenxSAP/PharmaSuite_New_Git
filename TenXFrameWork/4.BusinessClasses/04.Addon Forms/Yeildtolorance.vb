...
#End Region
    Public Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("YeildToleranceMaster.xml",
                                          "TNX_PYTM",
                                          ResourceType.Embeded)

            objForm = objMain.objApplication.Forms.GetForm("TNX_PYTM",
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_PYTM_H")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_PYTM_L")
            ...
            objMatrix.Columns.Item("C_0_1").Editable = True   'Stage Code
            objMatrix.Columns.Item("C_0_2").Editable = True   'Allowed Loss Percent
            objMatrix.Columns.Item("C_0_3").Editable = True   'Allowed Reject Percent
            objMatrix.Columns.Item("C_0_4").Editable = True   'Deviation Required
            ...
            "Yield Tolerance Master Form Loaded Successfully",
    ...
    Public Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("U_DevReq", 0, "N")
    ...
    Public Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Details.SetValue("U_AllLoss",
                                  oDBs_Details.Offset,
                                  "0")

            oDBs_Details.SetValue("U_AllReject",
                                  oDBs_Details.Offset,
                                  "0")
...
#Region "Menu Event"
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent,
        ...
        Try
            ...
            ' OPEN UDO FORM
            '========================================================================
            If pVal.MenuUID = "10X_PMS_YIELD" _
        ...
        AndAlso pVal.BeforeAction = False Then
                ...
                If objForm.TypeEx <> "TNX_PYTM" Then Exit Sub
        ...
        AndAlso pVal.BeforeAction = True Then
                ...
                Try
                    ...
                    oDBs_Details =
                objForm.DataSources.DBDataSources.Item("@TNX_PYTM_L")
                ...
                SAPbouiCOM.BoOrderType.ot_RowOrder)
                    ...
                    If oDBs_Details.Size = 0 Then
                        ...
                        oDBs_Details.SetValue("U_AllLoss", 0, "0")
                        oDBs_Details.SetValue("U_AllReject", 0, "0")
