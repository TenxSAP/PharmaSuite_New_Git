Public Class ClsMstrProductCategory
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrProductCategory.xml", "frm_PRDCAT", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_PRDCAT", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_PRD_CAT")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_PRD_CAT""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_RD_PCAT" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_DosageRequired", rowIndex, "")
            oDBs_Head.SetValue("U_StabilityRequired", rowIndex, "")
            oDBs_Head.SetValue("U_QCRequired", rowIndex, "")
            oDBs_Head.SetValue("U_Status", rowIndex, "Y")
            oDBs_Head.SetValue("U_Remarks", rowIndex, "Y")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_DosageRequired"", ""U_StabilityRequired"", ""U_QCRequired"", ""U_Status"", ""U_Remarks"" " & "FROM ""@TNX_PRD_CAT"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_DosageRequired", j, ors1.Fields.Item("U_DosageRequired").Value.ToString())
                    oDBs_Head.SetValue("U_StabilityRequired", j, ors1.Fields.Item("U_StabilityRequired").Value.ToString())
