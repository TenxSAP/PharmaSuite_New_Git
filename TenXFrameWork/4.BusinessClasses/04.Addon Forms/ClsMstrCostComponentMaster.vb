Public Class ClsMstrCostComponentMaster
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrCostComponentMaster.xml", "frm_COSTM", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_COSTM", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_COSTM_H")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_COSTM_H""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_COSTCPT" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_CType", rowIndex, "")
            oDBs_Head.SetValue("U_CMethod", rowIndex, "")
            oDBs_Head.SetValue("U_DValue", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_CType"", ""U_CMethod"", ""U_DValue"", ""U_Active"" " & "FROM ""@TNX_COSTM_H"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_CType", j, ors1.Fields.Item("U_CType").Value.ToString())
                    oDBs_Head.SetValue("U_CMethod", j, ors1.Fields.Item("U_CMethod").Value.ToString())
                    oDBs_Head.SetValue("U_DValue", j, ors1.Fields.Item("U_DValue").Value.ToString())
