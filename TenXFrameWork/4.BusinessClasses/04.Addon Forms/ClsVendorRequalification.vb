...
#End Region
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("VendorRequalification.xml", "frm_VREQ", ResourceType.Embeded)
