Public Class ClsSOPCategoryCompliance
...
#End Region
        ...
        Sub CreateForm()
            ...
            objMain.objUtilities.LoadForm("MstrSOPCategoryMaster.xml", "frm_SOPCATM", ResourceType.Embeded)

            objForm = objMain.objApplication.Forms.GetForm("frm_SOPCATM", objMain.objApplication.Forms.ActiveForm.TypeCount)

            objForm.Freeze(True)

                objutilities = New Utilities

            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_SOPCAT")
            ...
            rs.DoQuery(
            "SELECT TOP 1 ""Code"" FROM ""@TNX_SOPCAT""")
        ...
        Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent,
            ...
            If pVal.MenuUID = "10X_CMS_SOPCAT" _
        ...
        And oDBs_Head.GetValue("Code", 0).Trim = "" Then
            ...
            oDBs_Head.SetValue("U_DeptCode", rowIndex, "")
            oDBs_Head.SetValue("U_GMPReq", rowIndex, "")
            oDBs_Head.SetValue("U_ReviewFr", rowIndex, "")
            oDBs_Head.SetValue("U_TrainReq", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        ...
        Try
            ...
            rs1 = "SELECT ""Code"", ""Name"", ""U_DeptCode"", ""U_GMPReq"", " &
              """U_ReviewFr"", ""U_TrainReq"", ""U_ApprRoute"", ""U_Active"" " &
              "FROM ""@TNX_SOPCAT"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_DeptCode", j,
                                   ors1.Fields.Item("U_DeptCode").Value.ToString())

                    oDBs_Head.SetValue("U_GMPReq", j,
                                   ors1.Fields.Item("U_GMPReq").Value.ToString())

                    oDBs_Head.SetValue("U_ReviewFr", j,
                                   ors1.Fields.Item("U_ReviewFr").Value.ToString())

                    oDBs_Head.SetValue("U_TrainReq", j,
                                   ors1.Fields.Item("U_TrainReq").Value.ToString())
