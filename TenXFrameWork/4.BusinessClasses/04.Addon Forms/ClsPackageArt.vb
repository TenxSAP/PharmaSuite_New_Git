...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("PackageArtwork.xml", "10X_ARTWRK", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_ARTWRK", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_ARTWRK")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_ARTWRK1")

            objMatrix1 = objForm.Items.Item("0_U_G").Specific


            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_ARTWRK", "Primary"))
            oDBs_Head.SetValue("U_DER", 0, DateTime.Now.ToString("yyyyMMdd"))
            ...
            objForm.Items.Item("DER").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, -1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            objForm.Items.Item("DER").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_ARTWRK"))
            oDBs_Head.SetValue("U_DER", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_Stage", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ApprovedBy", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ApprovedDate", oDBs_Details.Offset, "")
