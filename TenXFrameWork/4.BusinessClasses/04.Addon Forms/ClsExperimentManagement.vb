...
Public Class ClsExperimentManagement
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("ExperimentManagement.xml", "10X_EXP_MGT", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_EXP_MGT", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_EXP_HDR")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_EXP_ING")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_EXP_PROC")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_EXP_TEST")
            oDBs_Details4 = objForm.DataSources.DBDataSources.Item("@TNX_EXP_OBS")
            oDBs_Details5 = objForm.DataSources.DBDataSources.Item("@TNX_EXP_ATTACH1")
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_EXP"))
            oDBs_Head.SetValue("U_ExpDate", 0, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.MenuUID = "10X_EXP_MGT" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Private Sub SetNewLine1(ByVal FormUID As String)
        Try
            ...
            oDBs_Details1.SetValue("U_IngredientType", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_StdQty", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_TrialQty", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_UOM", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_VarQty", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_VarPer", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_Function", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_BatchStage", oDBs_Details1.Offset, "")
    ...
    Private Sub SetNewLine2(ByVal FormUID As String)
        Try
            ...
            oDBs_Details2.SetValue("LineId", oDBs_Details2.Offset, objMatrix2.VisualRowCount.ToString())
            oDBs_Details2.SetValue("U_StepNo", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_ProcessStage", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Instruction", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Equipment", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Temperature", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Humidity", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Duration", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Operator", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Observation", oDBs_Details2.Offset, "")
    ...
    Private Sub SetNewLine3(ByVal FormUID As String)
        Try
            ...
            oDBs_Details3.SetValue("LineId", oDBs_Details3.Offset, objMatrix3.VisualRowCount.ToString())
            oDBs_Details3.SetValue("U_ParamCode", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_ParamName", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_StdValue", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_MinValue", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_MaxValue", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_ActualValue", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_UOM", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_Result", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_TestedBy", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_TestDate", oDBs_Details3.Offset, "")
    ...
    Private Sub SetNewLine4(ByVal FormUID As String)
        Try
            ...
            oDBs_Details4.SetValue("LineId", oDBs_Details4.Offset, objMatrix4.VisualRowCount.ToString())
            oDBs_Details4.SetValue("U_ObsType", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_Observation", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_Deviation", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_CorrectiveAction", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_ObservedBy", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_ObsDate", oDBs_Details4.Offset, "")
    ...
    Private Sub SetNewLine5(ByVal FormUID As String)
        Try
            ...
            oDBs_Details5.SetValue("LineId", oDBs_Details5.Offset, objMatrix5.VisualRowCount.ToString())
            oDBs_Details5.SetValue("U_DocType", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_FileName", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_FilePath", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_UploadedBy", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_UploadDate", oDBs_Details5.Offset, "")
    ...
    Sub SetDefault(ByVal FormUID As String, Optional ByVal Flag As String = "", Optional ByVal Series As Integer = 0)
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_EXP", "Primary"))
            oDBs_Head.SetValue("U_ExpDate", 0, DateTime.Now.ToString("yyyyMMdd"))
            objMatrix1.Clear()
            objMatrix2.Clear()
            objMatrix3.Clear()
