...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("TestMethod.xml", "10X_QC_TM", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_QC_TM", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            'CheckCorporateTaxConfigSetup()
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_TMETHOD")
            objMatrix = objForm.Items.Item("CMxt_1").Specific
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_QC_TMETHOD" AndAlso pVal.BeforeAction = False Then
            ...
            ElseIf pVal.MenuUID = "1292" AndAlso pVal.BeforeAction = False Then
                ...
                If objForm.TypeEx <> "10X_QC_TM" Then Exit Sub

                objMatrix = CType(objForm.Items.Item("CMxt_1").Specific, SAPbouiCOM.Matrix)
                Me.SetNewLine(objForm.UniqueID)
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_MethodNo", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_Version", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_EquipReq", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_InstrType", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_SOPCode", oDBs_Head.Offset, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_TMETHOD")
            Dim objsectMat As SAPbouiCOM.Matrix = objForm.Items.Item("CMxt_1").Specific

            Dim rs1 As String = "SELECT ""DocEntry"",""Code"", ""U_MethodNo"", ""U_Version"", ""U_EquipReq"", ""U_InstrType"",""U_SOPCode"",""U_Active"",""U_Remarks"" " &
                                "FROM ""@TNX_QC_TMETHOD"" ORDER BY ""Code"" "
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 1 To ors1.RecordCount
                    ...
                    oDBs_Head.SetValue("U_MethodNo", oDBs_Head.Offset, ors1.Fields.Item("U_MethodNo").Value.ToString())
                    oDBs_Head.SetValue("U_Version", oDBs_Head.Offset, ors1.Fields.Item("U_Version").Value.ToString())
                    oDBs_Head.SetValue("U_EquipReq", oDBs_Head.Offset, ors1.Fields.Item("U_EquipReq").Value.ToString())
                    oDBs_Head.SetValue("U_InstrType", oDBs_Head.Offset, ors1.Fields.Item("U_InstrType").Value.ToString())
                    oDBs_Head.SetValue("U_SOPCode", oDBs_Head.Offset, ors1.Fields.Item("U_SOPCode").Value.ToString())
