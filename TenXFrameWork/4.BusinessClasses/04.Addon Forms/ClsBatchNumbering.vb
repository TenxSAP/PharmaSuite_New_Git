...
Public Class ClsBatchNumbering
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("BatchNumbering.xml", "10X_BNUM", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_BNUM", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_BNUM")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_BNUM1")

            objMatrix1 = objForm.Items.Item("0_U_G").Specific


            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_BNUM", "Primary"))
            oDBs_Head.SetValue("U_DUE", 0, DateTime.Now.ToString("yyyyMMdd"))
            ...
            objForm.Items.Item("DUE").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, -1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            objForm.Items.Item("DUE").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_BNUM", "Primary"))
            oDBs_Head.SetValue("U_DUE", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_ItemGroup", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ItemCode", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ProductPrefix", oDBs_Details.Offset, "")
