...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("Artwork.xml", "REG_ARTTYP", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("REG_ARTTYP", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_REG_ARTTYP")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_REG_ARTTYP""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_RMS_ARTTYP" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_CompType", rowIndex, "")
            oDBs_Head.SetValue("U_LangReq", rowIndex, "")
            oDBs_Head.SetValue("U_VerCtrl", rowIndex, "")
            oDBs_Head.SetValue("U_QAAppr", rowIndex, "Y")
            oDBs_Head.SetValue("U_RegAppr", rowIndex, "")
            oDBs_Head.SetValue("U_MktAppr", rowIndex, "")
            oDBs_Head.SetValue("U_AttachMan", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_CompType"", ""U_LangReq"", ""U_VerCtrl"", ""U_QAAppr"", ""U_RegAppr"", ""U_MktAppr"", ""U_AttachMan"", ""U_Status"", ""U_Remarks"" " & "FROM ""@TNX_REG_ARTTYP"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_CompType", j, ors1.Fields.Item("U_CompType").Value.ToString())
                    oDBs_Head.SetValue("U_LangReq", j, ors1.Fields.Item("U_LangReq").Value.ToString())
                    oDBs_Head.SetValue("U_VerCtrl", j, ors1.Fields.Item("U_VerCtrl").Value.ToString())
                    oDBs_Head.SetValue("U_QAAppr", j, ors1.Fields.Item("U_QAAppr").Value.ToString())
                    oDBs_Head.SetValue("U_RegAppr", j, ors1.Fields.Item("U_RegAppr").Value.ToString())
                    oDBs_Head.SetValue("U_MktAppr", j, ors1.Fields.Item("U_MktAppr").Value.ToString())
                    oDBs_Head.SetValue("U_AttachMan", j, ors1.Fields.Item("U_AttachMan").Value.ToString())
                    oDBs_Head.SetValue("U_Status", j, ors1.Fields.Item("U_Status").Value.ToString())
                    oDBs_Head.SetValue("U_Remarks", j, ors1.Fields.Item("U_Remarks").Value.ToString())
