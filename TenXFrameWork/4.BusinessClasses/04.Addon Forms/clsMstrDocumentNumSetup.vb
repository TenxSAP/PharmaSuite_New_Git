Public Class clsMstrDocumentNumSetup
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_DOCNUM")
            ...
            rs.DoQuery(
            "SELECT TOP 1 ""Code"" FROM ""@TNX_DOCNUM""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent,
        ...
        Try
            ...
            If pVal.MenuUID = "10X_CMS_DOCNUM" _
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        And oDBs_Head.GetValue("Code", 0).Trim = "" Then
            ...
            oDBs_Head.SetValue("U_Prefix", rowIndex, "")
            oDBs_Head.SetValue("U_YearFormat", rowIndex, "")
            oDBs_Head.SetValue("U_NextNumber", rowIndex, "")
            oDBs_Head.SetValue("U_Padding", rowIndex, "")
            oDBs_Head.SetValue("U_Suffix", rowIndex, "")
            oDBs_Head.SetValue("U_Active", rowIndex, "Y")
            oDBs_Head.SetValue("U_ResetP", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        ...
        objForm.Items.Item("CMtx").Specific
            ...
            rs1 = "SELECT ""Code"",""Name"", ""U_DocType"", ""U_Prefix"", ""U_YearFormat"", ""U_NextNumber"", ""U_Padding"", ""U_Suffix"", ""U_Active"",""U_ResetP"" " &
        "FROM ""@TNX_DOCNUM"" ORDER BY ""Code"""
        ...
        SAPbobsCOM.BoObjectTypes.BoRecordset)
            ...
            If ors1.RecordCount > 0 Then
                ...
                "U_Prefix",
                j,
                ors1.Fields.Item("U_Prefix").Value.ToString())

                    oDBs_Head.SetValue(
                "U_YearFormat",
                j,
                ors1.Fields.Item("U_YearFormat").Value.ToString())

                    oDBs_Head.SetValue(
                "U_NextNumber",
                j,
                ors1.Fields.Item("U_NextNumber").Value.ToString())

                    oDBs_Head.SetValue(
                "U_Padding",
                j,
                ors1.Fields.Item("U_Padding").Value.ToString())

                    oDBs_Head.SetValue(
                "U_Suffix",
                j,
                ors1.Fields.Item("U_Suffix").Value.ToString())

                    oDBs_Head.SetValue(
                "U_ResetP",
                j,
                ors1.Fields.Item("U_ResetP").Value.ToString())
