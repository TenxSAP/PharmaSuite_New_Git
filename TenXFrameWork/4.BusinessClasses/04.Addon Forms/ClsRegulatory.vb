...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("Regulatory.xml", "10X_REG_REPO", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_REG_REPO", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_REG_REPH")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_REG_REPL")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_REG_REPV")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_REG_REPA")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_REG_REPU")
            oDBs_Details4 = objForm.DataSources.DBDataSources.Item("@TNX_REG_REPAP")
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_REG_REPO", "Primary"))
            oDBs_Head.SetValue("U_DKM", 0, DateTime.Now.ToString("yyyyMMdd"))
            ...
            objForm.Items.Item("DKM").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, -1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            objForm.Items.Item("DKM").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_REG_REPO"))
            oDBs_Head.SetValue("U_DKM", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_LineDocType", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_FileName", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_FileFormat", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_FileLanguage", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_AttachEntry", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Mandatory", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_DocDate", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ValidFrom", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ValidTo", oDBs_Details.Offset, "")
            ...
            If objMatrix2.VisualRowCount = 0 Then
                ...
                oDBs_Details1.SetValue("U_VersionNo", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_RevisionNo", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_ChangeReason", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_ChangeSummary", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_PreviousVersion", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_EffectiveDate", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_SupersededDate", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_AttachEntry", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Status", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_CreatedBy", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_CreatedDate", oDBs_Details1.Offset, "")
            ...
            If objMatrix3.VisualRowCount = 0 Then
                ...
                oDBs_Details2.SetValue("U_RoleCode", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_UserCode", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CanView", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CanDownload", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CanUpload", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CanApprove", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CanArchive", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_AccessRemarks", oDBs_Details2.Offset, "")
            ...
            If objMatrix4.VisualRowCount = 0 Then
                ...
                oDBs_Details3.SetValue("U_TargetObject", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_TargetDocEntry", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_TargetDocNum", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_UsedDate", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_UsedBy", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_UsagePurpose", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_StatusAtUse", oDBs_Details3.Offset, "")
            ...
            If objMatrix5.VisualRowCount = 0 Then
                ...
                oDBs_Details4.SetValue("U_StageNo", oDBs_Details4.Offset, "")
                oDBs_Details4.SetValue("U_ApproverRole", oDBs_Details4.Offset, "")
                oDBs_Details4.SetValue("U_ApproverUser", oDBs_Details4.Offset, "")
                oDBs_Details4.SetValue("U_ApprovalStatus", oDBs_Details4.Offset, "")
                oDBs_Details4.SetValue("U_ApprovalDate", oDBs_Details4.Offset, "")
                oDBs_Details4.SetValue("U_ApprovalTime", oDBs_Details4.Offset, "")
                oDBs_Details4.SetValue("U_Remarks", oDBs_Details4.Offset, "")
                oDBs_Details4.SetValue("U_IsMandatory", oDBs_Details4.Offset, "")
