Public Class ClsRootCauseCompliance
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("RootCauseMaster.xml", "ROOTMSTR", ResourceType.Embeded)

            objForm = objMain.objApplication.Forms.GetForm("ROOTMSTR", objMain.objApplication.Forms.ActiveForm.TypeCount)

            objForm.Freeze(True)

            objutilities = New Utilities

            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_ROOT")
        ...
        SAPbobsCOM.BoObjectTypes.BoRecordset)
            ...
            rs.DoQuery(
        "SELECT TOP 1 ""Code"" FROM ""@TNX_ROOT""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent,
        ...
        Try
            ...
            If pVal.MenuUID = "10X_CMS_ROOT" _
    ...
    And oDBs_Head.GetValue("Code", 0).Trim = "" Then
            ...
            oDBs_Head.SetValue("U_Descript", rowIndex, "")
            oDBs_Head.SetValue("U_DefCAPA", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        ...
        Try
            ...
            rs1 = "SELECT ""Code"", ""U_Category"", ""U_Descript"", " &
          """U_DefCAPA"", ""U_Active"" FROM ""@TNX_ROOT"" ORDER BY ""Code"""
           ...
           SAPbobsCOM.BoObjectTypes.BoRecordset)
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_Category", j,
                               ors1.Fields.Item("U_Category").Value.ToString())

                    oDBs_Head.SetValue("U_Descript", j,
                               ors1.Fields.Item("U_Descript").Value.ToString())

                    oDBs_Head.SetValue("U_DefCAPA", j,
                               ors1.Fields.Item("U_DefCAPA").Value.ToString())
