Public Class ClsMstrVersionControlSetup
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrVersionControlSetup.xml", "frm_VERSET", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_VERSET", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_VER_SET")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_VER_SET""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_RD_VERCTRL" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_ObjectType", rowIndex, "")
            oDBs_Head.SetValue("U_VersionFormat", rowIndex, "")
            oDBs_Head.SetValue("U_AutoIncrement", rowIndex, "Y")
            oDBs_Head.SetValue("U_ApprovalRequired", rowIndex, "Y")
            oDBs_Head.SetValue("U_LockApprovedVersion", rowIndex, "Y")
            oDBs_Head.SetValue("U_AllowRollback", rowIndex, "Y")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""Name"", ""U_ObjectType"", ""U_VersionFormat"", ""U_AutoIncrement"", ""U_ApprovalRequired"", ""U_LockApprovedVersion"", ""U_AllowRollback"", ""U_Status"" " & "FROM ""@TNX_VER_SET"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_ObjectType", j, ors1.Fields.Item("U_ObjectType").Value.ToString())
                    oDBs_Head.SetValue("U_VersionFormat", j, ors1.Fields.Item("U_VersionFormat").Value.ToString())
                    oDBs_Head.SetValue("U_AutoIncrement", j, ors1.Fields.Item("U_AutoIncrement").Value.ToString())
                    oDBs_Head.SetValue("U_ApprovalRequired", j, ors1.Fields.Item("U_ApprovalRequired").Value.ToString())
                    oDBs_Head.SetValue("U_LockApprovedVersion", j, ors1.Fields.Item("U_LockApprovedVersion").Value.ToString())
                    oDBs_Head.SetValue("U_AllowRollback", j, ors1.Fields.Item("U_AllowRollback").Value.ToString())
