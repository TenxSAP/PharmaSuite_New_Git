...
Public Class ClsNewMaterialRequest
...
#Region "Create Form"
    ...
    Public Sub CreateForm()
        ...
        Try
            objMain.objUtilities.LoadForm("NewMaterialRequest.xml", "TNX_MQ_NMR", ResourceType.Embeded)

            objForm = objMain.objApplication.Forms.GetForm("TNX_MQ_NMR",
                      objMain.objApplication.Forms.ActiveForm.TypeCount)


            objForm.Freeze(True)

            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_MQ_NMR_H")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_MQ_NMR_APP")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_MQ_NMR_ATT")


            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_MQ_NMR", "Primary"))
...
#Region "Default Values"
    ...
    Public Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            '  Me.CreateForm()
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_MQ_NMR", "Primary"))
            oDBs_Head.SetValue("U_REQDATE", 0, DateTime.Now.ToString("yyyyMMdd"))
...
#Region "Add New Line For All Matrices"
    ...
    Private Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_MQ_NMR_APP")
            objMatrix = CType(objForm.Items.Item("1_U_G").Specific, SAPbouiCOM.Matrix)

            objMatrix.AddRow()
            oDBs_Details1.SetValue("LineId", oDBs_Details1.Offset, objMatrix.VisualRowCount.ToString())
            oDBs_Details1.SetValue("U_STAGE", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_APPROVER", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_STATUS", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_APPDATE", oDBs_Details1.Offset, "")
            ...
            oDBs_Details2.SetValue("U_ATCPATH", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_UPLOADBY", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_UPLOADDT", oDBs_Details2.Offset, "")
            objMatrix.SetLineData(objMatrix.VisualRowCount)
            objMatrix.AutoResizeColumns()
...
#Region "Menu Event"
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.MenuUID = "10X_NMR" And pVal.BeforeAction = False Then
                Me.CreateForm()
            ...
            ElseIf pVal.MenuUID = "774" And pVal.BeforeAction = False Then
                objForm = objMain.objApplication.Forms.GetForm("TNX_MQ_NMR", objMain.objApplication.Forms.ActiveForm.TypeCount)

                objMatrix1 = objForm.Items.Item("1_U_G").Specific
                objMatrix2 = objForm.Items.Item("0_U_G").Specific


                If MATRIXS.Equals("1_U_G") Then
                ...
                ElseIf MATRIXS.Equals("0_U_G") Then
...
#Region "Item Event"
    Public Sub ItemEvent(ByVal FormUID As String,
        ...
        If pVal.EventType = SAPbouiCOM.BoEventTypes.et_CLICK Then
            ...
            If (pVal.ItemUID = "1_U_G" Or pVal.ItemUID = "0_U_G") And pVal.BeforeAction = True Then
                MATRIXS = pVal.ItemUID
            End If

            If pVal.ItemUID = "0_U_FD" Then
                ChkMatrix = "1_U_G"
            ElseIf pVal.ItemUID = "1_U_FD" Then
                ChkMatrix = "0_U_G"
