Public Class ClsValidationTypeMasterCompliance
...
#End Region
        ...
        Sub CreateForm()
            ...
            objMain.objUtilities.LoadForm("ValidationTypeMaster.xml", "VLTYMSTR", ResourceType.Embeded)

            objForm = objMain.objApplication.Forms.GetForm("VLTYMSTR", objMain.objApplication.Forms.ActiveForm.TypeCount)

            objForm.Freeze(True)

                objutilities = New Utilities

            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_VALTYP")
            ...
            rs.DoQuery(
            "SELECT TOP 1 ""Code"" FROM ""@TNX_VALTYP""")
        ...
        Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent,
            ...
            If pVal.MenuUID = "10X_CMS_VALTYP" _
        ...
        And oDBs_Head.GetValue("Code", 0).Trim = "" Then
            ...
            oDBs_Head.SetValue("U_IQReq", rowIndex, "")
            oDBs_Head.SetValue("U_OQReq", rowIndex, "")
            oDBs_Head.SetValue("U_PQReq", rowIndex, "")
            oDBs_Head.SetValue("U_ProtoReq", rowIndex, "")
            oDBs_Head.SetValue("U_ReportReq", rowIndex, "")
            oDBs_Head.SetValue("U_ApprRoute", rowIndex, "")
            oDBs_Head.SetValue("U_RevalFr", rowIndex, "")
        ...
        Public Sub MatrixLoad()
            ...
            rs1 = "SELECT ""Code"", ""U_IQReq"", ""U_OQReq"", ""U_PQReq"", " &
              """U_ProtoReq"", ""U_ReportReq"", ""U_ApprRoute"",""U_RevalFr"", ""U_Active"" " &
              "FROM ""@TNX_VALTYP"" ORDER BY ""Code"""
            ...
            Dim ors1 As SAPbobsCOM.Recordset
               ...
               SAPbobsCOM.BoObjectTypes.BoRecordset)
                ...
                If ors1.RecordCount > 0 Then
                    ...
                    oDBs_Head.SetValue("U_IQReq", j,
                                   ors1.Fields.Item("U_IQReq").Value.ToString())

                    oDBs_Head.SetValue("U_OQReq", j,
                                   ors1.Fields.Item("U_OQReq").Value.ToString())

                    oDBs_Head.SetValue("U_PQReq", j,
                                   ors1.Fields.Item("U_PQReq").Value.ToString())

                    oDBs_Head.SetValue("U_ProtoReq", j,
                                   ors1.Fields.Item("U_ProtoReq").Value.ToString())

                    oDBs_Head.SetValue("U_ReportReq", j,
                                   ors1.Fields.Item("U_ReportReq").Value.ToString())

                    oDBs_Head.SetValue("U_ApprRoute", j,
                                   ors1.Fields.Item("U_ApprRoute").Value.ToString())

                    oDBs_Head.SetValue("U_RevalFr", j,
                                   ors1.Fields.Item("U_RevalFr").Value.ToString())
