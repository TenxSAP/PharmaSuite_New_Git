Public Class ClsMstrPharmaLeadTimeMaster
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("MstrPharmaLeadTimeMaster.xml", "frm_LEAD", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_LEAD", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_LEAD_H")
            ...
            rs.DoQuery("SELECT TOP 1 ""Code"" FROM ""@TNX_LEAD_H""")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_PHRLEAD" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_PrDays", rowIndex, "")
            oDBs_Head.SetValue("U_QADays", rowIndex, "")
            oDBs_Head.SetValue("U_PDays", rowIndex, "")
            oDBs_Head.SetValue("U_DDays", rowIndex, "")
            oDBs_Head.SetValue("U_BDays", rowIndex, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            Dim rs1 As String
            rs1 = "SELECT ""Code"",""U_ItemCode"", ""U_PrDays"", ""U_QADays"", ""U_PDays"", ""U_DDays"", ""U_BDays"" " & "FROM ""@TNX_LEAD_H"" ORDER BY ""Code"""
            ...
            If ors1.RecordCount > 0 Then
                For j As Integer = 0 To ors1.RecordCount - 1
                    ...
                    oDBs_Head.SetValue("U_PrDays", j, ors1.Fields.Item("U_PrDays").Value.ToString())
                    oDBs_Head.SetValue("U_QADays", j, ors1.Fields.Item("U_QADays").Value.ToString())
                    oDBs_Head.SetValue("U_PDays", j, ors1.Fields.Item("U_PDays").Value.ToString())
                    oDBs_Head.SetValue("U_DDays", j, ors1.Fields.Item("U_DDays").Value.ToString())
                    oDBs_Head.SetValue("U_BDays", j, ors1.Fields.Item("U_BDays").Value.ToString())
