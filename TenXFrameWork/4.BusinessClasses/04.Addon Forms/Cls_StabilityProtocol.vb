...
Public Class Cls_StabilityProtocol
...
#End Region
    ...
    Sub CreateForm()
        ...
        Try
            ...
            objMain.objUtilities.LoadForm("StabilityProtocal.xml", "PROTOCOL", ResourceType.Embeded)
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_STAB_PROTO")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_STAB_PROTO_T")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_STAB_PROTO_S")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent,
        ...
        Try
            ...
            If pVal.MenuUID = "10X_STB_PROTO" And pVal.BeforeAction = False Then
                Me.CreateForm()
    ...
    Sub SetNewLine1(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_STAB_PROTO_T")
            ...
            oDBs_Details2.SetValue("U_TestCode", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_TestName", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_MethodCode", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_SpecMin", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_SpecMax", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_UOM", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_Critical", oDBs_Details2.Offset, "")
            ' FIXED ISSUE HERE
            objMatrix1.SetLineData(objMatrix1.VisualRowCount)
    ...
    Sub SetNewLine2(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Details2.SetValue("U_DAYSS", oDBs_Details2.Offset, "0")
            oDBs_Details2.SetValue("U_SAMPQ", oDBs_Details2.Offset, "0")
            oDBs_Details2.SetValue("U_TESTR", oDBs_Details2.Offset, "")
    ...
    Sub SetDefault(ByVal FormUID As String)
        Try
            ...
            "SELECT IFNULL(MAX(""DocNum""),0)+1 AS ""DocNum"" FROM ""@TNX_STAB_PROTO"""
