...
Public Class ClsFormulaCosting


#Region "Declaration"

    Public objForm As SAPbouiCOM.Form
    Public objMatrix, objMatrix1, objMatrix2, objMatrix3, objMatrix4, objMatrix5, objMatrix6 As SAPbouiCOM.Matrix
    Dim oDBs_Head As SAPbouiCOM.DBDataSource
    Dim oDBs_Details As SAPbouiCOM.DBDataSource
    Dim oDBs_Details1, oDBs_Details2, oDBs_Details3, oDBs_Details4, oDBs_Details5, oDBs_Details6 As SAPbouiCOM.DBDataSource
    Dim oDBs_Attach As SAPbouiCOM.DBDataSource
    Dim oDS As SAPbouiCOM.DBDataSource
    Dim objComboBox, objComboBox1 As SAPbouiCOM.ComboBox
    Dim MATRIXS, ChkMatrix As String
...
#Region "Create Form"
    ...
    Public Sub CreateForm()
        ...
        Try
            objMain.objUtilities.LoadForm("FormulaCosting.xml", "FORMULACOSTING", ResourceType.Embeded)

            objForm = objMain.objApplication.Forms.GetForm("FORMULACOSTING",
                      objMain.objApplication.Forms.ActiveForm.TypeCount)


                objForm.Freeze(True)

                oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_H")
                oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D1")
                oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D2")
                oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D3")
                oDBs_Details4 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D4")
                oDBs_Details5 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D5")
            oDBs_Details6 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_AUD")
            ...
            '  LoadCompanyDetails(objForm.UniqueID)c
...
#Region "Add New Line For All Matrices"
    ...
    Private Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            '====================================================
            ' Matrix 1 : Ingredient Change Details
            ' Table    : @TNX_FRM_VER_D1
            '====================================================
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D1")
            ...
            oDBs_Details1.SetValue("U_ITEM_CODE", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_ITEM_NAME", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_OLD_QTY", oDBs_Details1.Offset, "0")
            oDBs_Details1.SetValue("U_NEW_QTY", oDBs_Details1.Offset, "0")
            oDBs_Details1.SetValue("U_DIFF_QTY", oDBs_Details1.Offset, "0")
            oDBs_Details1.SetValue("U_UOM", oDBs_Details1.Offset, "")
            oDBs_Details1.SetValue("U_CHG_TYPE", oDBs_Details1.Offset, "")
            ...
            '====================================================
            ' Matrix 2 : Process Change Details
            ' Table    : @TNX_FRM_VER_D2
            '====================================================
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D2")
            objMatrix = CType(objForm.Items.Item("MXT_2").Specific, SAPbouiCOM.Matrix)

            objMatrix.AddRow()
            oDBs_Details2.SetValue("LineId", oDBs_Details2.Offset, objMatrix.VisualRowCount.ToString())
            oDBs_Details2.SetValue("U_STEP_NO", oDBs_Details2.Offset, "0")
            oDBs_Details2.SetValue("U_STAGE", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_OLD_INST", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_NEW_INST", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_CHG_TYPE", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_MACHINE", oDBs_Details2.Offset, "")
            oDBs_Details2.SetValue("U_DURATION", oDBs_Details2.Offset, "0")
            oDBs_Details2.SetValue("U_REMARKS", oDBs_Details2.Offset, "")
            objMatrix.SetLineData(objMatrix.VisualRowCount)
            objMatrix.AutoResizeColumns()

            '====================================================
            ' Matrix 3 : Quality Regulatory Impact
            ' Table    : @TNX_FRM_VER_D3
            '====================================================
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D3")
            objMatrix = CType(objForm.Items.Item("MXT_3").Specific, SAPbouiCOM.Matrix)

            objMatrix.AddRow()
            oDBs_Details3.SetValue("LineId", oDBs_Details3.Offset, objMatrix.VisualRowCount.ToString())
            oDBs_Details3.SetValue("U_IMP_AREA", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_REQUIRED", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_RISK_LVL", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_RV_BY", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_RV_STS", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_RV_DATE", oDBs_Details3.Offset, "")
            oDBs_Details3.SetValue("U_COMMENTS", oDBs_Details3.Offset, "")
            objMatrix.SetLineData(objMatrix.VisualRowCount)
            objMatrix.AutoResizeColumns()

            '====================================================
            ' Matrix 4 : Attachments
            ' Table    : @TNX_FRM_VER_D4
            '====================================================
            oDBs_Details4 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D4")
            objMatrix = CType(objForm.Items.Item("MTX_4").Specific, SAPbouiCOM.Matrix)

            objMatrix.AddRow()
            oDBs_Details4.SetValue("LineId", oDBs_Details4.Offset, objMatrix.VisualRowCount.ToString())
            oDBs_Details4.SetValue("U_DOC_TYPE", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_FILE_NAME", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_FILE_PATH", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_UPLD_BY", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_UPLD_DT", oDBs_Details4.Offset, "")
            oDBs_Details4.SetValue("U_REMARKS", oDBs_Details4.Offset, "")
            objMatrix.SetLineData(objMatrix.VisualRowCount)
            objMatrix.AutoResizeColumns()

            '====================================================
            ' Matrix 5 : Approval History
            ' Table    : @TNX_FRM_VER_D5
            '====================================================
            oDBs_Details5 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D5")
            objMatrix = CType(objForm.Items.Item("MTX_5").Specific, SAPbouiCOM.Matrix)

            objMatrix.AddRow()
            oDBs_Details5.SetValue("LineId", oDBs_Details5.Offset, objMatrix.VisualRowCount.ToString())
            oDBs_Details5.SetValue("U_STAGE", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_APPROVER", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_ROLE", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_STATUS", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_DSC_DT", oDBs_Details5.Offset, "")
            oDBs_Details5.SetValue("U_REMARKS", oDBs_Details5.Offset, "")
            objMatrix.SetLineData(objMatrix.VisualRowCount)
            objMatrix.AutoResizeColumns()

            '====================================================
            ' Matrix 6 : Audit Trail
            ' Table    : @TNX_FRM_VER_AUD
            '====================================================
            oDBs_Details6 = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_AUD")
            objMatrix = CType(objForm.Items.Item("MTX_6").Specific, SAPbouiCOM.Matrix)

            objMatrix.AddRow()
            oDBs_Details6.SetValue("LineId", oDBs_Details6.Offset, objMatrix.VisualRowCount.ToString())
            oDBs_Details6.SetValue("U_ACT_DT", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_USER", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_ACTION", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_FIELD", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_OLD_VAL", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_NEW_VAL", oDBs_Details6.Offset, "")
            oDBs_Details6.SetValue("U_REMARKS", oDBs_Details6.Offset, "")
            objMatrix.SetLineData(objMatrix.VisualRowCount)
            objMatrix.AutoResizeColumns()

        Catch ex As Exception
            objMain.objApplication.StatusBar.SetText("SetNewLine Error : " & ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
        End Try
    End Sub
...
#End Region
    ...
    '=========================================================
    ' Common SetNewLine Method
    ' Pass the Matrix UID from Menu Event
    '=========================================================
    Private Sub SetNewLine1(ByVal FormUID As String, ByVal MatrixUID As String)
...
#Region "Menu Event"
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
            Try
            If pVal.MenuUID = "10X_COST" And pVal.BeforeAction = False Then
                Me.CreateForm()
            ...
            ElseIf pVal.MenuUID = "1292" And pVal.BeforeAction = False Then
                ...
                Me.SetNewLine1(objForm.UniqueID, ChkMatrix)

            ElseIf pVal.MenuUID = "774" And pVal.BeforeAction = False Then
                objForm = objMain.objApplication.Forms.GetForm("FORMULACOSTING", objMain.objApplication.Forms.ActiveForm.TypeCount)
                ...
                If MATRIXS.Equals("MXT_1") Then
                    Dim rowCount As Integer = objMatrix.VisualRowCount

                    If objMatrix.IsRowSelected(1) <> True And rowCount < 1 Then
                        objMatrix.AddRow()
                        oDBs_Details1.SetValue("LineId", oDBs_Details1.Offset, objMatrix.VisualRowCount)
                        objMatrix.SetLineData(objMatrix.VisualRowCount)
                    End If
                ...
                ElseIf MATRIXS.Equals("MXT_2") Then
                    Dim rowCount2 As Integer = objMatrix2.VisualRowCount


                    If objMatrix2.IsRowSelected(1) <> True And rowCount2 < 1 Then
                        objMatrix2.AddRow()
                    ...
                    For i As Integer = rowCount2 To 1 Step -1
                        If objMatrix2.IsRowSelected(i) Then
                            objMatrix2.DeleteRow(i)
                        End If
                    Next

                    For i As Integer = 1 To objMatrix2.VisualRowCount
                        objMatrix2.Columns.Item("LineId").Cells.Item(i).Specific.Value = i
                    Next
                End If
...
#Region "Item Event"
        ...
        If pVal.EventType = SAPbouiCOM.BoEventTypes.et_CLICK Then
            ...
            If (pVal.ItemUID = "MXT_1" Or pVal.ItemUID = "MXT_2" Or pVal.ItemUID = "MXT_3" Or pVal.ItemUID = "MTX_4" Or pVal.ItemUID = "MTX_5" Or pVal.ItemUID = "MTX_6") And pVal.BeforeAction = True Then
            ...
            ElseIf pVal.ItemUID = "Item_9" Then
                ChkMatrix = "MXT_2"
            ElseIf pVal.ItemUID = "Item_13" Then
                ChkMatrix = "MXT_3"
            ElseIf pVal.ItemUID = "Item_29" Then
                ChkMatrix = "MTX_4"
            ElseIf pVal.ItemUID = "Item_31" Then
                ChkMatrix = "MTX_5"
            ElseIf pVal.ItemUID = "Item_33" Then
                ChkMatrix = "MTX_6"
                'Else
                '    ChkMatrix = "Mtx"
            End If
        ...
        If pVal.ItemUID = "btn_Del" Then
                ...
                objMatrix2 = CType(objForm.Items.Item("MTX_4").Specific, SAPbouiCOM.Matrix)
                oDBs_Attach = objForm.DataSources.DBDataSources.Item("@TNX_FRM_VER_D4")
                ...
                Dim selectedRow As Integer = 0
                    ...
                    If oDBs_Attach.Size = 0 Then
                        oDBs_Attach.InsertRecord(0)
                    oDBs_Attach.SetValue("LineId", 0, "1")
                    oDBs_Attach.SetValue("U_DOC_TYPE", 0, "")
                    oDBs_Attach.SetValue("U_FILE_PATH", 0, "")
                    oDBs_Attach.SetValue("U_FILE_NAME", 0, "")
                    oDBs_Attach.SetValue("U_UPL_DT", 0, "")
                    oDBs_Attach.SetValue("U_UPLD_BY", 0, "")
                    oDBs_Attach.SetValue("U_REMARKS", 0, "")
        ...
        If pVal.EventType = SAPbouiCOM.BoEventTypes.et_DOUBLE_CLICK AndAlso pVal.BeforeAction = False Then
            If pVal.ItemUID = "MTX_4" And pVal.ColUID = "FILE_PATH" And pVal.BeforeAction = False Then
                objForm = objMain.objApplication.Forms.Item(FormUID)
                Dim objMatrix As SAPbouiCOM.Matrix = objForm.Items.Item("MTX_4").Specific


                If pVal.Row > 0 AndAlso pVal.Row <= objMatrix.VisualRowCount Then
                    Dim fullPath As String = objMatrix.Columns.Item("FILE_PATH").Cells.Item(pVal.Row).Specific.Value
                    If Not String.IsNullOrEmpty(fullPath) AndAlso fullPath.Contains("\") Then
                        ...
                        objMatrix.Columns.Item("FILE_NAME").Cells.Item(pVal.Row).Specific.Value = filename
                        objMatrix.Columns.Item("UPL_DT").Cells.Item(pVal.Row).Specific.Value = DateTime.Now.ToString("yyyyMMdd")
