...
Public Class ClsValidationManage
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("Validation_v1.xml", "10X_VAL", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_VAL", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_VALH")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_VALP")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_VALSTEP")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_VALRES")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_VALAP")
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_VAL_UDO", "Primary"))
            oDBs_Head.SetValue("U_DDM", 0, DateTime.Now.ToString("yyyyMMdd"))
            ...
            objForm.Items.Item("DDM").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, -1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            objForm.Items.Item("DDM").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_VAL_UDO"))
            oDBs_Head.SetValue("U_DDM", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_Objective", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Scope", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_AccCrit", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_SampPlan", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RespDept", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RespUser", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_TargetDate", oDBs_Details.Offset, "")
            ...
            If objMatrix2.VisualRowCount = 0 Then
                ...
                oDBs_Details1.SetValue("U_Phase", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_TestName", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_TestMeth", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Parameter", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_ExpValue", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_MinLimit", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_MaxLimit", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_UOM", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Freq", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Resp", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Mandatory", oDBs_Details1.Offset, "")
            ...
            If objMatrix3.VisualRowCount = 0 Then
                ...
                oDBs_Details2.SetValue("U_TestName", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_ActValue", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_ResultTxt", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_Result", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_Deviation", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_DevDE", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CAPADE", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_AttachE", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_TestedBy", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_TestDate", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_VerBy", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_VerDate", oDBs_Details2.Offset, "")
            ...
            If objMatrix4.VisualRowCount = 0 Then
                ...
                oDBs_Details3.SetValue("U_Role", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_Approver", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_Status", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_ActDate", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_Comments", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_ESignRef", oDBs_Details3.Offset, "")
