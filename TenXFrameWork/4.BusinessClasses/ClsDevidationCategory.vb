Public Class ClsDevidationCategory
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("DeviationMaster.xml", "10X_DEVCAT", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_DEVCAT", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            'CheckCorporateTaxConfigSetup()
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_DEVCAT")
    ...
    Sub MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean)
        ...
        Try
            ...
            If pVal.MenuUID = "10X_QC_DEVCAT" AndAlso pVal.BeforeAction = False Then
            ...
            ElseIf pVal.MenuUID = "1292" AndAlso pVal.BeforeAction = False Then
                ...
                If objForm.TypeEx <> "10X_DEVCAT" Then Exit Sub
    ...
    Sub SetNewLine(ByVal FormUID As String)
        Try
            ...
            oDBs_Head.SetValue("U_Severity", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_DefOwn", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_AppReq", oDBs_Head.Offset, "")
            oDBs_Head.SetValue("U_CloDays", oDBs_Head.Offset, "")
    ...
    Public Sub MatrixLoad()
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Add("@TNX_QC_DEVCAT")
            Dim objsectMat As SAPbouiCOM.Matrix = objForm.Items.Item("MXT_1").Specific

            Dim rs1 As String = "SELECT ""DocEntry"",""Code"", ""Name"", ""U_Severity"", ""U_DefOwn"", ""U_AppReq"", ""U_CloDays"",""U_Active"" " &
"FROM ""@TNX_QC_DEVCAT"" ORDER BY ""Code"" "
            ...
            If ors1.RecordCount > 0 Then
                ...
                For j As Integer = 1 To ors1.RecordCount
                    ...
                    oDBs_Head.SetValue("U_Severity", oDBs_Head.Offset, ors1.Fields.Item("U_Severity").Value)
                    oDBs_Head.SetValue("U_DefOwn", oDBs_Head.Offset, ors1.Fields.Item("U_DefOwn").Value)
                    oDBs_Head.SetValue("U_AppReq", oDBs_Head.Offset, ors1.Fields.Item("U_AppReq").Value)
                    oDBs_Head.SetValue("U_CloDays", oDBs_Head.Offset, ors1.Fields.Item("U_CloDays").Value)
