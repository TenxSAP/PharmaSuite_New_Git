...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("COATemplate.xml", "10X_COAT", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_COAT", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_QC_COAT_H")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_QC_COAT_L")

            objMatrix1 = objForm.Items.Item("0_U_G").Specific


            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_COAT", "Primary"))
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_COAT"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("LineId", oDBs_Details.Offset, objMatrix1.VisualRowCount)
                oDBs_Details.SetValue("U_PrintSection", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_FieldName", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Visible", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_SortOrder", oDBs_Details.Offset, "")
                objMatrix1.SetLineData(objMatrix1.VisualRowCount)
