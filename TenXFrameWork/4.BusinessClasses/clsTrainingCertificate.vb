...
Public Class clsTrainingCertificate
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("TrainingCertificate.xml", "frm_TRNCERT", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("frm_TRNCERT", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_TRNCH")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_TRNCL")


            objMatrix1 = objForm.Items.Item("0_U_G").Specific

            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "UDO_TNX_TRNCERT"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_CertNo", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Qualify", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_QualArea", oDBs_Details.Offset, "")
        ...
        Try
            ...
            Select Case MatrixUID
                Case "0_U_G"
                    ...
                    oDBs_Details.SetValue("U_CertCode", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_TrainExec", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_TrainPlan", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_IssueDate", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_ValidFrm", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_ValidTo", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_CertStat", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_ApprBy", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_AttEntry", oDBs_Details.Offset, "")
                    oDBs_Details.SetValue("U_Remarks", oDBs_Details.Offset, "")
