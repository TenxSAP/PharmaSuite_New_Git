...
Public Class ClsIncidentManage
...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("Incident Management_v2.xml", "10X_INC", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_INC", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_INCH")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_INCL")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_INCACT")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_INCAP")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_INCAT")
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_INC_UDO", "Primary"))
            oDBs_Head.SetValue("U_DDT", 0, DateTime.Now.ToString("yyyyMMdd"))
            ...
            objForm.Items.Item("DDT").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, -1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            objForm.Items.Item("DDT").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_INC_UDO"))
            oDBs_Head.SetValue("U_DDT", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            objForm = objMain.objApplication.Forms.Item(FormUID)
            ' oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_CHGIMP")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_INCL")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_INCACT")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_INCAP")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_INCAT")
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_InvStep", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Response", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_EvdType", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_EvdRef", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RCFlag", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RCType", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Resp", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_InvDate", oDBs_Details.Offset, "")
            ...
            If objMatrix2.VisualRowCount = 0 Then
                ...
                oDBs_Details1.SetValue("U_ActType", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_ActDesc", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_ActOwner", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Dept", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_DueDate", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_CompDate", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_Status", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_EvdAttach", oDBs_Details1.Offset, "0")
                oDBs_Details1.SetValue("U_VerBy", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_VerDate", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_VerRem", oDBs_Details1.Offset, "")
            ...
            If objMatrix3.VisualRowCount = 0 Then
                ...
                oDBs_Details2.SetValue("U_CAPANo", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CAPAType", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_CAPAStat", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_LinkDate", oDBs_Details2.Offset, "")
            ...
            If objMatrix4.VisualRowCount = 0 Then
                ...
                oDBs_Details3.SetValue("U_AttachType", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_AttachE", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_FileName", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_Descr", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_UploadBy", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_UploadDt", oDBs_Details3.Offset, "")
                'oDBs_Details3.SetValue("U_CAPAReq", oDBs_Details3.Offset, "")
                'oDBs_Details3.SetValue("U_CAPADE", oDBs_Details3.Offset, "0")
