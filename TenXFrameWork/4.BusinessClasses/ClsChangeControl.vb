...
#End Region
    ...
    Sub CreateForm()
        Try
            objMain.objUtilities.LoadForm("ControlForm_v1.xml", "10X_CHG", ResourceType.Embeded)
            objForm = objMain.objApplication.Forms.GetForm("10X_CHG", objMain.objApplication.Forms.ActiveForm.TypeCount)
            objForm.Freeze(True)
            objutilities = New Utilities
            oDBs_Head = objForm.DataSources.DBDataSources.Item("@TNX_CHGH")
            oDBs_Details = objForm.DataSources.DBDataSources.Item("@TNX_CHGIMP")
            oDBs_Details1 = objForm.DataSources.DBDataSources.Item("@TNX_CHGAP")
            oDBs_Details2 = objForm.DataSources.DBDataSources.Item("@TNX_CHGTASK")
            oDBs_Details3 = objForm.DataSources.DBDataSources.Item("@TNX_CHGVER")
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_CHG_UDO", "Primary"))
            oDBs_Head.SetValue("U_DDN", 0, DateTime.Now.ToString("yyyyMMdd"))
            ...
            objForm.Items.Item("DDN").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, -1, SAPbouiCOM.BoModeVisualBehavior.mvb_False)
            objForm.Items.Item("DDN").SetAutoManagedAttribute(SAPbouiCOM.BoAutoManagedAttr.ama_Editable, 4, SAPbouiCOM.BoModeVisualBehavior.mvb_True)
    ...
    Sub SetDefault(ByVal FormUID As String)
        ...
        Try
            ...
            oDBs_Head.SetValue("DocNum", oDBs_Head.Offset, objMain.objUtilities.GetNextDocNum(objForm, "TNX_CHG_UDO"))
            oDBs_Head.SetValue("U_DDN", oDBs_Head.Offset, DateTime.Now.ToString("yyyyMMdd"))
    ...
    Sub SetNewLine(ByVal FormUID As String)
        ...
        Try
            ...
            If objMatrix1.VisualRowCount = 0 Then
                ...
                oDBs_Details.SetValue("U_Area", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ImpType", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ImpDesc", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Severity", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Prob", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_Detect", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RiskScore", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_ActReq", oDBs_Details.Offset, "")
                oDBs_Details.SetValue("U_RecAction", oDBs_Details.Offset, "")
            ...
            If objMatrix2.VisualRowCount = 0 Then
                ...
                oDBs_Details1.SetValue("U_AppRole", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_AppUser", oDBs_Details1.Offset, "")
                oDBs_Details1.SetValue("U_AppStatus", oDBs_Details1.Offset, "")
            ...
            If objMatrix3.VisualRowCount = 0 Then
                ...
                oDBs_Details2.SetValue("U_TaskCode", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_TaskName", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_TaskType", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_TaskDesc", oDBs_Details2.Offset, "")
                ...
                oDBs_Details2.SetValue("U_EvdReq", oDBs_Details2.Offset, "")
                oDBs_Details2.SetValue("U_AttachE", oDBs_Details2.Offset, "0")
            ...
            If objMatrix4.VisualRowCount = 0 Then
                ...
                oDBs_Details3.SetValue("U_VerPoint", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_AccCrit", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_Result", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_Obs", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_VerBy", oDBs_Details3.Offset, "")
                oDBs_Details3.SetValue("U_VerDate", oDBs_Details3.Offset, "")
        ...
        Try
            ...
            '====================================================
                ...
                Case "3_U_G"
                    ...
                    oDBs_Details3.SetValue("U_VerDate", oDBs_Details3.Offset, "")
                    oDBs_Details3.SetValue("U_CAPAReq", oDBs_Details3.Offset, "")
                    oDBs_Details3.SetValue("U_CAPADE", oDBs_Details3.Offset, "")
